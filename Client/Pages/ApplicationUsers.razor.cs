...
namespace DotNetGalutinis.Client.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<DotNetGalutinis.Server.Models.ApplicationUser> users;
        protected RadzenDataGrid<DotNetGalutinis.Server.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(DotNetGalutinis.Server.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(DotNetGalutinis.Server.Models.ApplicationUser user)
        {
            try
            {
