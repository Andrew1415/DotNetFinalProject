...
namespace DotNetGalutinis.Client.Pages
{
    public partial class ApplicationRoles
    {
        ...
        protected RadzenDataGrid<DotNetGalutinis.Server.Models.ApplicationRole> grid0;
        ...
        protected async Task DeleteClick(DotNetGalutinis.Server.Models.ApplicationRole role)
        {
            try
            {
